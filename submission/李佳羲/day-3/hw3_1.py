...
INPUT_JSON = "/data-mnt/data/camp-2025/jxli/SummerQuest-2025/handout/day-3/query_and_output.json"
...
for item in tasks:
    ...
    # 解码验证
    decoded = tokenizer.decode(ids,skip_special_tokens=False) # TODO
